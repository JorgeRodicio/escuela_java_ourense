...
public class TestServicioUsuarios {
    ...
    public void crearUsuariosValidos() {
        Usuario u1 = srvUsu.crear("arrrr@aaa", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("a@a.a2", "1234", "Nom B", "30");
        Usuario u3 = srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40");
        
        assertTrue(srvUsu.leerUno("arrrr@aaa").getId() > 0);
    ...
    public void modificarUsuariosValidos() {
        ...
        assertEquals(25, srvUsu.leerUno("arrrr@aaa").getEdad());
    ...
    public void eliminarUsuarios() {
        ...
        assertNull(srvUsu.leerUno("arrrr@aaa"));
    ...
    public void listarTodos() {
        ...
        lista.add(srvUsu.crear("arrrr@aaa", "1234", "Nom A", "20"));
        lista.add(srvUsu.crear("a@a.a2", "1234", "Nom B", "30"));
        lista.add(srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40"));
        
        ArrayList<Usuario> listaTodos = srvUsu.leerTodos();
        
        for (Usuario usuario : listaTodos) {
            if(usuario != null && listaTodos.contains(usuario)){
                srvUsu.eliminar(usuario.getId());
            }else{
                fail("No se ha añadido o encontrado en listaTotal");
            }
        }
    }
}
